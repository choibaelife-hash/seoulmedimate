    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 mt-4">{t('login_title')}</h1>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors font-medium"
          >
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            {t('no_account')}{' '}
            <Link href={`/${locale}/auth/signup`} className="text-brand-600 hover:underline font-medium">
              {t('signup_link')}
            </Link>
          </p>
        </div>
