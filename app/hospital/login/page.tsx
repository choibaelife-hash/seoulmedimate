    ...
    <div className="min-h-screen bg-[#f0f4f8] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1a3a5c]">병원 파트너 로그인</h1>
          <p className="text-sm text-gray-500 mt-1">SeoulMediMate 병원 어드민 포털</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            병원 제휴 신청은{' '}
            <Link href="/hospital/signup" className="text-[#2e86c1] hover:underline font-medium">여기서 신청</Link>
          </p>
        </div>
      </div>
    </div>
